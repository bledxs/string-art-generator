          ...
          <div className='container mx-auto max-w-6xl'>
            <div className='text-center space-y-6'>
              ...
              <p className='text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto'>
                Create stunning string art patterns from any image using
                advanced algorithms. Free, fast, and powerful.
              </p>
            ...
            <div className='space-y-8'>
              <div className='flex gap-6 items-start'>
                ...
                <div>
                  ...
                  <p className='text-muted-foreground'>
                    Drag and drop or click to upload any image. Supports PNG,
                    JPG, JPEG, and WebP formats.
                  </p>
                </div>
              </div>
              ...
              <div className='flex gap-6 items-start'>
                ...
                <div>
                  ...
                  <p className='text-muted-foreground'>
                    Fine-tune the number of pins (50-400), lines (500-5000),
                    line weight, opacity, and background color to match your
                    vision.
                  </p>
                </div>
              </div>
              ...
              <div className='flex gap-6 items-start'>
                ...
                <div>
                  ...
                  <p className='text-muted-foreground'>
                    Click generate and watch as the algorithm creates your
                    string art. Download in your preferred format and start
                    building!
                  </p>
                </div>
              </div>

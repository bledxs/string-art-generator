...
import type {
  ...
  ScaledImageDetails,
  Thread,
} from '../../types/string-art';
import { getPinPositions } from '@/lib/geometry-utils';
...
>((props, ref) => {
  ...
  return (
    <canvas
      ...
      className='border-input rounded-md max-h-[600px] max-w-[600px] mx-auto' // Clases base de estilo
      data-string-art-canvas
      style={{

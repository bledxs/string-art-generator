...
export function generateSvgString(
  ...
  <circle cx="${size / 2}" cy="${size / 2}" r="${(size / 2) * 0.95}" fill="none" stroke="#e2e8f0" stroke-width="2" />
  <path d="${pathData}" fill="none" stroke="#0f172a" stroke-width="${lineWeight}" stroke-opacity="${opacity}" stroke-linecap="round" stroke-linejoin="round" />
</svg>`;
}
